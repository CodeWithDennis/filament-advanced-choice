    ...
    <fieldset aria-label="{{ $getLabel() }}" class="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-3 sm:gap-x-4">
        @foreach($getOptions() as $value => $label)
            ...
            >
                ...
                <svg class="invisible size-5 text-primary-600 dark:text-primary-500 group-has-checked:visible" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">
