                ...
                >
                    ...
                    >
                        ...
                        <div class="fi-fo-checkbox-list-option-text flex-1">
                            ...
                            @if ($description)
                                <span class="fi-fo-checkbox-list-option-description mt-1 block text-sm text-gray-500 dark:text-gray-400">{{ $description }}</span>
                            @endif
                            @if ($extra)
                                <span class="fi-fo-checkbox-list-option-extra mt-6 block text-sm font-medium text-gray-900 dark:text-gray-100">{{ $extra }}</span>
                            @endif
                        </div>
                        @if(!$hiddenInputs)
                            <input
                                ...
                                {{
                                    $extraInputAttributeBag
                                        ...
                                        ->class([
                                            'fi-checkbox-input cursor-[inherit] mt-0.5 shrink-0 ml-3 checked:bg-custom-500 checked:border-custom-500 hover:checked:bg-custom-600 hover:checked:border-custom-600 focus:border-custom-500 focus:ring-custom-500',
